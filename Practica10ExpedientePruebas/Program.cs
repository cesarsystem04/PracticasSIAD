...
public class Program
{
    ...
    public static void MostrarMenu()
    {
        ...
        Console.WriteLine("\n--- Menú de Opciones ---");
        Console.Clear();
        Console.WriteLine("1. Registrar Expediente pruebas");
        Console.WriteLine("2. Listar Expediente pruebas");
        Console.WriteLine("3. Actualizar Expediente pruebas");
            ...
            detalleFabricacion = new List<DetalleFabricacion>()
  {
    ...
    {
        ExpedientePruebasServices services = new ExpedientePruebasServices();
        Task<HttpResponseMessage> result = services.Leer(1, 3);
        if (!result.Result.IsSuccessStatusCode)
            Console.WriteLine($"ERROR:  {result.Result.Content.ReadAsStringAsync().Result ?? string.Empty}");
        else
        {
